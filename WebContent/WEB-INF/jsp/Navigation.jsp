		...
		<div class="row">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="${pageContext.request.contextPath}/">
					<img class="logo" src="/images/trivItUpLogo.png" alt="logo">
				</a>
			</div>
			<div class="navbar-collapse collapse row">
				<ul class="nav navbar-nav pull-right">
					<li><a class="butt happy-butt butt-space"
						href="${pageContext.request.contextPath}/game">Profile</a></li>
					<li><a class="butt sad-butt butt-space"
